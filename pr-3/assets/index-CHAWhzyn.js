...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Hn,depthTest:!1,depthWrite:!1})}function i0(i,e,t){const n=new Float32Array(mi),r=new C(0,1,0);return new _n({name:"SphericalGaussianBlur",defines:{n:mi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Os(),fragmentShader:`
...
`].filter(xr).join(`
`)),a=Mo(a),a=uc(a,t),a=hc(a,t),o=Mo(o),o=uc(o,t),o=hc(o,t),a=dc(a),o=dc(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
