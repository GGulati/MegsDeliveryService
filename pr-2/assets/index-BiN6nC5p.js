...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function qm(i,e,t){const n=new Float32Array(mi),r=new C(0,1,0);return new Pn({name:"SphericalGaussianBlur",defines:{n:mi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Ns(),fragmentShader:`
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function Zl(){return new Pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ns(),fragmentShader:`
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function Jl(){return new Pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ns(),fragmentShader:`
